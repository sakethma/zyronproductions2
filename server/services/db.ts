      ...
      await tx.insert(bookings)
        ...
        .onConflictDoUpdate({
          ...
          set: {
            ...
            ticket_id: sql`EXCLUDED.ticket_id`,
            utr: sql`EXCLUDED.utr`,
            payment_proof_url: sql`EXCLUDED.payment_proof_url`,
            ocr_detected_utr: sql`EXCLUDED.ocr_detected_utr`,
            ocr_detected_amount: sql`EXCLUDED.ocr_detected_amount`,
            rejection_reason: sql`EXCLUDED.rejection_reason`,
            whatsapp_status: sql`EXCLUDED.whatsapp_status`,
            reminder_sent: sql`EXCLUDED.reminder_sent`,
            reminder_sent_at: sql`EXCLUDED.reminder_sent_at`,
